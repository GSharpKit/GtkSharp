...
namespace Gst
{
	...
	public static class DynamicSignal
	{
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_g_closure_new_simple (int size, IntPtr data);
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate uint d_g_signal_connect_closure (IntPtr instance, string name, IntPtr closure, bool after);
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_g_closure_set_meta_marshal (IntPtr closure, IntPtr data, GClosureMarshal marshal);
		static d_g_closure_set_meta_marshal g_closure_set_meta_marshal = FuncLoader.LoadFunction<d_g_closure_set_meta_marshal>(FuncLoader.GetProcAddress(GLibrary.Load(Library.GObject), "g_closure_set_meta_marshal"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate int d_g_signal_handler_disconnect (IntPtr o, uint handler_id);
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_g_signal_emitv (GLib.Value[] parameters, uint signal_id, uint detail, ref GLib.Value return_value);
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_g_signal_query (uint signal_id, ref GSignalQuery query);
